...
/* package Jigsaw-0.1.0.0 */
#ifndef VERSION_Jigsaw
#define VERSION_Jigsaw "0.1.0.0"
#endif /* VERSION_Jigsaw */
#ifndef MIN_VERSION_Jigsaw
#define MIN_VERSION_Jigsaw(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Jigsaw */
...
#define CURRENT_COMPONENT_ID "Jigsaw-0.1.0.0-Ahpij6ChCoIDlMMeqMsd7w-Jigsaw"
